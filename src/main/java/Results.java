...
/**Klasa definiująca metody które uzyskują z mapy {@link Map} stan złota i wypisują je do pliku .txt*/
public class Results implements IResults
{
    ...
    public void printResults(IMap Mapa,int time) throws IOException
    {
